...
Rdata_dir='D:/JooGitRepo/RainyNight/tcga_example-master/Rdata/'
Figure_dir='D:/JooGitRepo/RainyNight/tcga_example-master/figures/'
...
source('D:/JooGitRepo/RainyNight/tcga_example-master/functions.R')
